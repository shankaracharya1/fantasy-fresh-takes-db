      ...
      <section className="overview-flow-section">
        ...
        <div className="metric-grid three-col">
          ...
          <MetricCard
            ...
            hint="Ad counts only when formula thresholds are met"
          />
          <MetricCard
              ...
              {fullGenAiByBeat.length > 0 ? (
                fullGenAiByBeat.flatMap((row) => {
                  ...
                  return [
                    ...
                    ...(isExpanded
                      ? [
                          <tr key={`${angleKey}-header`} style={{ background: "var(--bg-subtle, #f5f0e8)" }}>
                            <td colSpan={2} style={{ fontSize: 11, fontWeight: 600, color: "var(--muted)", paddingLeft: 24 }}>Asset Code</td>
                          ...
                          ...row.ads.map((ad) => (
                            <tr key={`${angleKey}-${ad.assetCode}`} style={{ background: "var(--bg-subtle, #f5f0e8)" }} className={ad.success ? "overview-genai-success-row" : ""}>
                              <td colSpan={2} style={{ paddingLeft: 24, fontSize: 12 }}>{ad.assetCode || "-"}</td>
        ...
        <div className="overview-guidelines-card">
          ...
          <div className="overview-guidelines-line">
            A successful ad is one where all formula thresholds pass for that attempt.
          </div>
          <div className="overview-guidelines-line">
          ...
          <div className="overview-guidelines-line">
            Beats with zero successful ads in the selected range stay unshaded and should be reviewed for iteration.
          </div>
        </div>
      </section>
