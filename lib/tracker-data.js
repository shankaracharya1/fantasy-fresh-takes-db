...
export const STAGES = [
  { id: "beats_ideation", label: "Beats ideation", color: "#1a4731", bg: "#d6efe2", text: "#14532d" },
  { id: "writing", label: "Writing", color: "#3b82f6", bg: "#dbeafe", text: "#1e40af" },
  { id: "cl_review", label: "CL review", color: "#10b981", bg: "#d1fae5", text: "#065f46" },
  { id: "production", label: "Production", color: "#8b5cf6", bg: "#ede9fe", text: "#5b21b6" },
  { id: "live_on_meta", label: "Live on Meta", color: "#2563eb", bg: "#dbeafe", text: "#1e3a8a" },
